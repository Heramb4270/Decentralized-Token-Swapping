...
export default function MessageModal(props) {
  return (
    <div className="Model effect-fade-in fixed inset-0 z-20 grid max-h-screen max-w-full place-content-center justify-center">
      ...
      <div className="Model_box h-[28rem] w-[40rem] rounded-3xl bg-gradient-to-b from-[#000e29] to-[#04183d] px-11 py-9 shadow-2xl ring-2 ring-[#ffb1ce]">
        ...
        <div className="align-middle items-center margin-auto">
          <p className="w-[100%] h-[15rem] overflow-auto no-scrollbar mx-0 my-8 text-xl items-center opacity-90 text-white">
            {props.message}
          </p>
